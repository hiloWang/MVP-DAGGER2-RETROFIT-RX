...
public class BaseRecyclerViewHolder extends RecyclerView.ViewHolder {
	 ...
	 */
	public void setOnItemClickListener(final BaseRecyclerViewHolder.OnItemClickListener listener,
					final int position) {
		if (listener == null) {
	...
	public void setOnItemLongClickListener(
					final BaseRecyclerViewHolder.OnItemLongClickListener listener,final int position) {
		if (listener == null) {
