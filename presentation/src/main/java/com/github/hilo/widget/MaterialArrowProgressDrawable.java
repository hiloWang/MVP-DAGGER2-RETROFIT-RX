...
public class MaterialArrowProgressDrawable extends Drawable implements Animatable {
	...
	public MaterialArrowProgressDrawable(Context context,View animExcutor) {
	...
	private void applyFinishTranslation(float interpolatedTime,Ring ring) {
		...
		final float startTrim = ring.getStartingStartTrim() + (ring.getStartingEndTrim() - ring.getStartingStartTrim()) *
						interpolatedTime;
