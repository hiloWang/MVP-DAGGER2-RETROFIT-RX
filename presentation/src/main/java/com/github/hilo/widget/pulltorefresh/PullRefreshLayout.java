...
public class PullRefreshLayout extends ViewGroup {
	...
	public PullRefreshLayout(Context context,AttributeSet attrs) {
		...
		final int colorsId = a.getResourceId(R.styleable.PullRefreshLayout_colors,
																				 R.array.google_colors);
		...
		//        mRefreshDrawable.setColorSchemeColors(new int[]{Color.rgb(0xC9, 0x34, 0x37), Color
		// .rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)});
	...
	@Override public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			if (mRefreshing) {
				...
				float tensionSlingshotPercent = Math.max(0,Math.min(extraOS,
																														slingshotDist * 2) / slingshotDist);
